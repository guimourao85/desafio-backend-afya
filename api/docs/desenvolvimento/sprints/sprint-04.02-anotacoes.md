...
| `Idempotency-Key` em requisição HTTP          | **DEBT-05** / sprint 06.01 — o `demo.seed.ts` virou idempotente nesta sprint (issue 8), mas é script de terminal, não rota |
