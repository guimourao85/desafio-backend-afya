...
/**
 * Sonda de teste: um DTO simples e estável para exercitar duas peças do kernel sem
 * depender do corpo de uma rota de produção — o `APP_PIPE` global (400 com
 * `details[]`) e a derivação do schema Zod para o OpenAPI.
 *
...
export class ProbeController {
  // `@Public()`: o guard global fecha toda rota, e esta sonda existe para exercitar
  // **pipe e filtro**. Sem isto, os testes de envelope passariam a provar o guard e
  // parariam de provar o que foram escritos para provar.
